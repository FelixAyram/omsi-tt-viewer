...
import { loadMapLazy, validateOmsiInstall, listMapCatalog } from "./map_processor.js?v=26";
import {
  pickOmsiRoot,
  pickMapFolder,
  pickOmsiAssetsRoot,
...
import { RAIL_TYP, ROUTE_PALETTE, FREE_START, BUSSTOP, SELECTED } from "./colors.js?v=26";
import { distPointPolyline } from "./geometry.js?v=26";
import {
  initDebugPanel,
  debugClear,
  debugPrint,
